...
public class GUI extends JFrame {
	...
	public CompletableFuture<Card> chooseCardFromHand(List<Card> availableCards, String name, String messageKey) {
		this.clear();
		this.setVisible(true);
		...
		title = name + ": " + title + ": " + GameConstants.messages.getString(messageKey);
		this.setTitle(title);
